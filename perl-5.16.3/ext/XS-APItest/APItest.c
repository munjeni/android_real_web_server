...
XS_EUPXS(XS_XS__APItest_stringify)
{
    ...
    if (items != 1)
       croak_xs_usage(cv,  "sv");
    {
#line 3299 "APItest.xs"
    const char *pv;
#line 5464 "APItest.c"
	SV *	sv = ST(0)
;
#line 3301 "APItest.xs"
    pv = SvPV_nolen(sv);
#line 5469 "APItest.c"
    }
    XSRETURN_EMPTY;
...
XS_EUPXS(XS_XS__APItest__Magic_test_get_vtbl)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 3407 "APItest.xs"
	MGVTBL *have;
	MGVTBL *want;
#line 5719 "APItest.c"
	UV	RETVAL;
	dXSTARG;
#line 3410 "APItest.xs"
