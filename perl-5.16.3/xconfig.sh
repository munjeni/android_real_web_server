...
cf_time='Tue Dec 31 20:40:33 CET 2013'
chgrp=''
chmod='chmod'
chown=''
clocktype='long'
...
config_argc='6'
config_args='--keeplog --mode=buildmini --build= --buildarch=x86_64-unknown-linux-gnu --target-name=arm-linux-androideabi --target-arch=arm-linux-androideabi'
contains='grep'
cp='cp'
cpio=''
cpp_stuff='42'
